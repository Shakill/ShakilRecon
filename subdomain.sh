...
ffuf -u http://HFUZZ -H "FUZZ.HFUZZ" -w /root/recon/input.txt:HFUZZ -w /root/wordlist/SecLists/Discovery/DNS/dns-Jhaddix.txt:FUZZ -o /root/recon/$domain/subdomain/ffuf.txt
