...
export GITHUB_TOKEN=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
...
github-subdomains -t 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 -d $domain -o /root/recon/$domain/subdomain/github_sub.txt
...
ffuf -u http://HFUZZ -H "Host: FUZZ.HFUZZ" -w /root/practice/in.txt:HFUZZ -w /root/wordlist/SecLists/Discovery/DNS/dns-Jhaddix.txt:FUZZ -fs 0 -v  | grep "| URL |" | awk '{print $4}' | sed 's/^http[s]:\/\///g' | tee -a /root/recon/$domain/subdomain/ffuf.txt
